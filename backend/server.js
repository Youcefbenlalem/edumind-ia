...
const systemPrompt = `Tu es un professeur expert du programme scolaire algerien officiel (ONEC). ${ctx ? 'Contexte eleve: ' + ctx : ''} Regles: Reponds selon la methodologie algerienne. Si Arabe ou Education Islamique reponds en arabe, sinon en francais. Structure: definition, explication, exemple algerien concret, regle a retenir. Sois pedagogique et encourageant.`;
...
const systemPrompt = `Tu es un professeur expert du programme scolaire algerien officiel (ONEC). Tu generes des questions STRICTEMENT conformes au programme algerien. Tu reponds UNIQUEMENT en JSON valide, sans markdown, sans texte avant ou apres.`;
let userPrompt;
if (isMathPhys) {
userPrompt = `Cree 4 exercices de ${matiere} pour: ${ctx} Ecris les maths en texte simple: / pour fractions, ^ pour puissances, racine() pour racines. PAS de LaTeX. Retourne ce JSON: { "exercices": [ {"numero": 1, "titre": "...", "enonce": "...", "donnees": "...", "questions": ["1) ...","2) ..."], "correction": "...", "bareme": 5}, {"numero": 2, "titre": "...", "enonce": "...", "donnees": "...", "questions": ["1) ..."], "correction": "...", "bareme": 5}, {"numero": 3, "titre": "...", "enonce": "...", "donnees": "...", "questions": ["1) ..."], "correction": "...", "bareme": 5}, {"numero": 4, "titre": "...", "enonce": "...", "donnees": "...", "questions": ["1) ..."], "correction": "...", "bareme": 5} ] }`;
} else {
const arabe = [‘Arabe’,‘Education Islamique’,‘Éducation Islamique’,‘Litterature Arabe’,‘Littérature Arabe’].includes(matiere);
userPrompt = `Cree 8 questions QCM sur: ${ctx} ${arabe?'Questions et reponses en arabe.':'Questions et reponses en francais.'} Retourne ce JSON: { "questions": [ {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 0, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 1, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 2, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 0, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 3, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 1, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 2, "explication": "..."}, {"question": "...", "options": ["A) ...","B) ...","C) ...","D) ..."], "correct": 0, "explication": "..."} ] }`;
}
